...
public class AssistantService {
    ...
    @GET
    @Path("get-assistants")
    public Page<YunUsers> getAssistants(@QueryParam("userId") String userId,@QueryParam("perPage") @NumberFormat int perPage,@QueryParam("currentPage") @NumberFormat int currentPage){
    ...
    public Page<YunUsers> getHisAssistant(@QueryParam("userName")String userName,@QueryParam("userId")String userId,
                                          @QueryParam("perPage") @NumberFormat int perPage,@QueryParam("currentPage") @NumberFormat int currentPage)throws Exception{
